...
class db_thread(QThread):
    ...
    def run(self):
        ...
        if self.connection:
            ...
            data_str = "00000 temp temp gas temp temp temp gas temp gas temp gas temp temp temp temp gas gas gas \
            temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp \
            gas gas temp temp temp temp gas gas temp temp temp temp gas gas gas gas gas gas gas gas temp temp temp \
            temp gas gas gas temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas gas temp \
            temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas gas gas gas gas gas gas gas temp \
            temp temp temp gas gas gas temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas gas \
            temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas gas gas gas gas gas gas gas \
            temp temp temp temp gas gas gas temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas\
            gas temp temp temp temp gas gas temp temp temp temp gas gas temp temp temp temp gas gas gas gas gas gas gas gas gas gas"
            head = data_str.split()
            for idx, type in enumerate(head):
                this_floor = 0
                for floor, floor_nodes in enumerate(self.floor_idx_list):
    ...
    def data_analy(self, total_datas):
        try:
            ...
            if True in self.bg.eva_draw.Fire:
                ...
                change_scenario = self.check_scenario_changed(
                    [floor_data['index'] for floor_data in self.bg.scenario_data], scenario_idx)
                    ...
                    for minute in range(1, 61):
                        ...
                        if not self.bg.Watch_Present:
                            if minute == self.bg.time_gap:
                                watching_node = 'room' + str(self.bg.eva_draw.Start_floor) + str(
                        ...
                        danger_level_change = self.check_danger_level_changed(self.last_danger_level[minute],
                                                                              danger_level)
                        if danger_level_change:
